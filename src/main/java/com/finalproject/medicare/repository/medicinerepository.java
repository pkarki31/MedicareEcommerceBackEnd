...
public interface medicinerepository extends JpaRepository<Medicine, Integer> {
   ...
   // Users findByUsernameAndPassword(String username, String password);
    ...
    @Modifying
    @Transactional
    @Query("update Medicine m set m.medicine_name=:medicine_name,m.medicine_company=:medicine_company,m.description=:description,m.quantity=:quantity,m.price=:price,m.active=:active where m.m_id=:m_id")
